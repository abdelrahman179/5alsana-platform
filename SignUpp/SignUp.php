...
<body>
  <div class="wrapper">
        ...
        <div class="SignUp-form">
          <form name='form-signup' method="post" action="SignUp_process.php" enctype="multipart/form-data">
            ...
            <div id="extend_form" style="display:none">
              ...
              <div class="form-group">
                <div class="col-25">
                  <span class="span_style"> الخبرات </span>
                </div>
                <div class="col-75">
                  <input type="text" class="form-control" name="story" placeholder="عدد سنوات الخبرة فى المجال و نبذة عن الأعمال">
                </div>
              </div>

              <!-- *********  extend job adding part ********* -->
              <div class="form-group" id="work_sample_extend">
                <div id='myList1'>
                  <div class="col-25">
                    <span class="span_style"> بعض الاعمال </span>
                  </div>
                  <ul class="col_75_cont">
                    <li>
                      <div class="imgs">
                        <div class="field">
                    ...
                    <li>
                      <div class="desc">
                        <textarea class="form-control" name="story" placeholder="وصف العمل"></textarea>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div class="plus_btn_cont">
                <button class="plus_btnn" id="button" type="button" onclick="duplicate()"> <i class="fa fa-plus-circle" aria-hidden="true"></i></button>
              </div>
            </div>
    ...
    <script>
      /* append work sample part onclick */
      document.getElementById('button').onclick = duplicate;

      var i = 0;
      var original = document.getElementById('work_sample_extend');

      function duplicate() {
        var clone = original.cloneNode(true); // "deep" clone
        clone.id = "work_sample_extend" + ++i; // there can only be one element with an ID
        document.getElementById("work_sample_extend").appendChild(clone);
      ...
      /************extend form for service provider ************/
    function ExtendForm() {
